...
export class DiscoveryService {
  ...
  private servers: ServerInfo[] = [
    ...
    { url: 'https://indexer.openresist.com/', name: 'indexer.openresist.com', region: 'Europe' },
    { url: 'https://directory.yabu.me/', name: 'directory.yabu.me', region: 'Unknown' },
    { url: 'https://profiles.nostr1.com/', name: 'profiles.nostr1.com', region: 'Unknown' },
